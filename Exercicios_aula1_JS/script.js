...
console.log(`Você nasceu em ${ano_nasceu}`)
...
console.log(`A area de um circulo é igual a ${area}`)
...
console.log(`O valor de US${dollar} foi convertido em €${euro}`)
...
console.log(`O valor de ${metros} metros foi convertido para  ${centimetros} centímetros!`)
